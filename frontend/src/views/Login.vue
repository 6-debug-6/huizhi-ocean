    ...
    <div class="login-wrapper">
      ...
      <div class="brand-panel">
        <div class="brand-content">
          ...
          <p class="brand-subtitle">设备检修知识检索与作业系统</p>
...
const UserIcon = shallowRef({ render: () => null })
const LockIcon = shallowRef({ render: () => null })
import('element-plus').then(m => {
  UserIcon.value = m.User
  LockIcon.value = m.Lock
})
...
.shape-4 { width: 300px; height: 300px; background: #1d4ed8; bottom: 10%; right: 30%; }
